...
import {
  Box, Typography, Tooltip, Divider,
} from '@mui/material';
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Brand */}
      <Box className="flex items-center gap-2 px-5 mb-8">
        <Box
          sx={{
            width: 34,
            height: 34,
            ...
            {({ isActive }) => (
              <Box
                sx={{
                  ...
                  boxShadow: isActive ? '0 2px 8px rgba(25,28,29,0.04)' : 'none',
